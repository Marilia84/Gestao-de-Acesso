    ...
    >
      <div className="relative z-10 w-full space-y-6 overflow-x-hidden">
        ...
        <div className="space-y-6">
          {/* CARD DE CADASTRO */}
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm px-4 sm:px-6 md:px-8 py-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <div className="lg:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="mt-1 border border-gray-300 rounded-lg px-3 py-2.5 w-full focus:ring-2 focus:ring-[#038C3E] focus:border-[#038C3E]"
                  />
                </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm px-4 sm:px-6 md:px-8 py-5">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="pl-10 w-full md:w-1/2 rounded-lg border border-gray-300 bg-[#F9FAFB] h-10 focus:ring-2 focus:ring-[#038C3E] focus:border-[#038C3E] text-sm"
              />
            </div>
